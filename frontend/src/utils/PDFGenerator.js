...
export const pdfGenerator = {
  ...
  createSalesBalancePDF: (data, startDate, endDate) => {
    ...
    autoTable(doc, {
      body: [
        ...
        [
          "Ingresos Contado",
          formatCurrency(summary.payment_methods.CONTADO || 0),
        ],
        [
          "Ingresos Transferencia",
          formatCurrency(summary.payment_methods.TRANSFERENCIA || 0),
        ],
      ],
      startY: 55,
      theme: "plain",
  ...
  createInvoicesListPDF: (data, startDate, endDate) => {
    ...
    const tableRows = data.map((invoice) => [
      ...
      invoice.included_orders
        .map((o) => `#${o.order_id} (Mesa ${o.table_number})`)
        .join(", "),
    ]);
        ...
        didParseCell: function (data) {
          ...
          if (data.column.index === 5) {
            ...
            if (data.cell.raw === "BAJO") {
              ...
              data.cell.raw === "CRITICO" ||
              data.cell.raw === "AGOTADO"
            ) {
